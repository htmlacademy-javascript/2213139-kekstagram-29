...
const isPalindromeOne = (string) => string === string.split('').reverse('').join('');
...
const isPalindromeBad = (string) => string.replaceAll(' ', '').toLowerCase() === string.replaceAll(' ', '').toLowerCase().split('').reverse('').join('');

isPalindromeBad('Лёша на полке клопа нашёл ');
